...
const WatchList = ({watchList}) => {
  return (
    ...
    <div className='flex justify-center my-4'>
      <input type="text" placeholder='Search Movies' className='h-[2rem] w-[18rem] bg-gray-200 outline-none px-4 py-2' />
    </div>
 ...
 <tr className='border-b-2'>
   <td className='flex items-center px-6 py-4'>
     <img className='w-[10rem] h-[6rem]' src={`https://image.tmdb.org/t/p/original/${movie.poster_path}`}/>
